...
create table
  public.bottling_history (
    ...
    constraint bottling_history_potion_id_fkey foreign key (potion_id) references potion_types (id) on update cascade on delete restrict
  ) tablespace pg_default;
...
create table
  public.cart_contents (
    ...
    constraint cart_contents_potion_id_fkey foreign key (potion_id) references potion_types (id) on update restrict on delete restrict
  ) tablespace pg_default;
...
create table
  public.potion_catalog_history (
    ...
    constraint potion_catalog_history_potion_id_fkey foreign key (potion_id) references potion_types (id) on update cascade on delete restrict
  ) tablespace pg_default;
...
create table
  public.potion_types (
    ...
    constraint potion_types_sku_key unique (sku),
...
create table
  public.potion_ledger (
    ...
    constraint potion_ledger_potion_id_fkey foreign key (potion_id) references potion_types (id) on update cascade on delete restrict
  ) tablespace pg_default;
